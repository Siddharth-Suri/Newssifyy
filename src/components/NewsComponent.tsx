...
export function NewsComponent(props: topStoriesType) {
    ...
    return (
        <div className="p-2  sm:xl md:2xl lg:w-3xl border-b-2 mb-2 border-neutral-800 container mx-auto text-neutral-100 bg-black  hover:opacity-95 hover:rounded-2xl hover:bg-neutral-900 hover:pt-4  transition-all duration-200">
            ...
            <div className="flex text-sm gap-1 p-2 text-gray-400">
                <div>by: </div>
                <div
                    className="cursor-pointer hover:underline text-amber-500"
                    onClick={() => {
